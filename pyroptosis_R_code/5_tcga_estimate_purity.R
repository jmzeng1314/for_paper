...
estimate <- function(dat,pro){
  input.f='Rdata/tcga/pre/tcga_estimate_input.txt'
  output.f='Rdata/tcga/pre/tcga_estimate_gene.gct'
  output.ds='Rdata/tcga/pre/tcga_estimate_score.gct'
...
b4=ggplot(dat = a,aes(Group, TumorPurity))+
  ...
  theme_classic()+labs(x=' ')
b1|b2|b3|b4
ggsave('plot/tcga/pre/tcga_estimate.png',height = 5,width = 16)
dev.off()
b1
ggsave('plot/tcga/pre/tcga_estimate_StromalScore.png',height = 5,width = 5)
dev.off()
b2
ggsave('plot/tcga/pre/tcga_estimate_ImmuneScore.png',height = 5,width = 5)
dev.off()
b3
ggsave('plot/tcga/pre/tcga_estimate_ESTIMATEScore.png',height = 5,width = 5)
dev.off()
b4
ggsave('plot/tcga/pre/tcga_estimate_TumorPurity.png',height = 5,width = 5)
dev.off()
table(a$Group)
b=a[a$Group=='lowrisk',]
